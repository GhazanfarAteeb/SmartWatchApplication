...
public class ActivityMain extends AppCompatActivity implements DbThread.DBThreadListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        com.app.smartwatchapplication.databinding.ActivityMainBinding binding = ActivityMainBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());
        PermissionUtils.checkAndRequestPermissions(ActivityMain.this);
